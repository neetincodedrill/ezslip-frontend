...
const EditEmployeePopUp:FC<wrapperProps2> = ({flagDisplayFunc, flagemployee,id})=> {
...
<div className={styles.modalAddEmployee}>
    <div className={styles.formdiv}>
        <form onSubmit={handleSubmit}>
                ...
                {editDetailsSavedModal && <ModalChildWrapper flag={editDetailsSavedModal} functiondisplay={setEditDetailsSavedModal} targetChildModal="editDetailsSaved" flagDisplayFunc={flagDisplayFunc} flagemployee={flagemployee}/>}
