    ...
    <div className={styles.main}>
        <div className={styles.parent}>
              <div className={styles.firstRow}>
                  ...
                  <img
                    src = {formdataget?.organizationImage? formdataget.organizationImage : "/assets/images/profile-picture.png"}
                    alt="hello"
              ...
              <div className={styles.content}>
                  <div className={styles.oneline}>
                    ...
                    <div  className={styles.fetchdata}>{formdataget?.organizationLegalName}</div> 
                  </div>

                  <div className={styles.oneline}>
                   <div className={styles.heading}>Organistaion Type</div>  
                   <div className={styles.fetchdata}> {formdataget?.organizationType}</div>
                  </div>
